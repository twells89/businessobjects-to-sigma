...
export function convertXmlResumeToReport(ir, options = {}) {
  ...
  const placements = [
    ...
    place(pageId, 'page', 'xmlresume-academics', 0, 250, 372, 160),
    place(pageId, 'page', 'xmlresume-certifications', 380, 250, 376, 160),
    place(pageId, 'page', 'xmlresume-projects-heading', 0, 420, 372, 24),
    place(pageId, 'page', 'xmlresume-projects', 0, 440, 756, 520),
