...
export function convertXmlResumeToReport(ir, options = {}) {
  ...
  const placements = [
    ...
    place(pageId, 'page', 'xmlresume-address', 0, 132, 300, 90),
    place(pageId, 'page', 'xmlresume-contact', 380, 132, 376, 90),
    ...
    place(pageId, 'page', 'xmlresume-academics', 0, 250, 372, 180),
    place(pageId, 'page', 'xmlresume-certifications', 380, 250, 376, 180),
    place(pageId, 'page', 'xmlresume-projects-heading', 0, 440, 372, 24),
    place(pageId, 'page', 'xmlresume-projects', 0, 460, 756, 500),
